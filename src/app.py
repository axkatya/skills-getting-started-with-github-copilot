...
activities = {
    ...
    "Swimming Club": {
        "description": "Improve swimming techniques and endurance in guided sessions",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["noah@mergington.edu", "mia@mergington.edu"],
    },
    "Drama Club": {
        "description": "Practice acting, stage presence, and perform in school productions",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["lucas@mergington.edu", "amelia@mergington.edu"],
    },
    "Painting Workshop": {
        "description": "Explore drawing and painting techniques using different media",
    ...
    "Science Olympiad": {
        "description": "Collaborate on science challenges and prepare for competitions",
